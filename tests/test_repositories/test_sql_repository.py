...
class TestSQLRepository:
    ...
    async def test_create_electronic_device(self, pg_session: AsyncSession) -> None:
        ...
        repo: SQLRepository[ElectronicDevice, ElectronicDeviceSchema] = SQLRepository(
            pg_session, ElectronicDevice
        )
    ...
    async def test_create_microwave(self, pg_session: AsyncSession) -> None:
        ...
        repo: SQLRepository[Microwave, MicrowaveSchema] = SQLRepository(
            pg_session, Microwave
        )
    ...
    async def test_create_air_conditioner(self, pg_session: AsyncSession) -> None:
        ...
        repo: SQLRepository[AirConditioner, AirConditionerSchema] = SQLRepository(
            pg_session, AirConditioner
        )
    ...
    async def test_list_all_electronic_devices(
        ...
        all_electronic_devices: list[
            ElectronicDevice
        ] = await sql_electronic_device_repository.list_all()
    ...
    async def test_list_all_microwaves(self, pg_session: AsyncSession) -> None:
        ...
        microwave_repo: SQLRepository[Microwave, MicrowaveSchema] = SQLRepository(
            pg_session, Microwave
        )
    ...
    async def test_add(
        ...
        actual_device: Type[ElectronicDevice] | None = await pg_session.get_one(
            ElectronicDevice, 1
        )
    ...
    async def test_update(
        ...
        updated_device: Type[ElectronicDevice] | None = await pg_session.get_one(
            ElectronicDevice, 1
        )
    ...
    async def test_delete(
        ...
        actual_device: Type[ElectronicDevice] | None = await pg_session.get(
            ElectronicDevice, 1
        )
